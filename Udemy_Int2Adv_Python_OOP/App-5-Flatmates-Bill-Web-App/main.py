...
class ResultsPage(MethodView):
    def post(self):
        ...
        flatmate1 = flat.Flatmate(bill_form.name1.data, float(bill_form.days1.data))
        flatmate2 = flat.Flatmate(bill_form.name1.data, float(bill_form.days2.data))
...
class BillForm(Form):
    ...
    days2 = StringField('Days in the house: ', default=12)
